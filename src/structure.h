...
extern void Structure_ResetTicks(void);
...
extern int Structure_TechTree_RunRegressionTest(void);
...
extern bool Structure_AutoRepair_IsEnabled(uint8 houseID);
extern bool Structure_AutoRepair_IsAvailable(uint8 houseID);
extern bool Structure_AutoRepair_Set(uint8 houseID, int8 state);
extern int Structure_AutoRepair_RunRegressionTest(void);
extern void Structure_UpdateMap(Structure *s);
extern void Structure_RedrawMap(Structure *s);
extern void Structure_StartAnimation(Structure *s);
