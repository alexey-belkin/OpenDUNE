...
extern bool Unit_IsSandwormTarget(uint16 encoded);
extern bool Unit_AttackPosition_GetApproach(Unit *unit, uint16 encoded, uint16 *destination);
extern bool Unit_AttackPosition_IsManaged(const Unit *unit);
extern uint16 Unit_AttackPosition_GetTile(const Unit *unit);
...
extern void Unit_SortOrder(void);
...
extern int Unit_CombatBalance_RunRegressionTest(void);
...
extern uint16 UnitSelection_GetIndex(uint16 slot);
...
extern bool UnitSelection_HasTargetingSnapshot(void);
...
extern bool UnitSelection_Toggle(struct Unit *unit);
extern void UnitSelection_ClearControlGroups(void);
extern void UnitSelection_AssignControlGroup(uint16 group);
extern bool UnitSelection_RecallControlGroup(uint16 group);
extern bool UnitSelection_SelectSameTypeOnScreen(struct Unit *unit, bool additive);
...
extern uint8 UnitSelection_ControllingHouse(const Unit *unit);
extern bool UnitSelection_HouseMayOrder(const Unit *unit, uint8 houseID);
extern void UnitSelection_ApplyOrderToList(const uint16 *list, uint16 count, uint8 houseID, ActionType action, uint16 packed);
extern void UnitSelection_ApplyDefaultOrderToList(const uint16 *list, uint16 count, uint8 houseID, uint16 packed);
extern void UnitSelection_ApplyActionToList(const uint16 *list, uint16 count, uint8 houseID, ActionType action);
extern void UnitSelection_ApplyHuntToList(const uint16 *list, uint16 count, uint8 houseID);
extern void UnitSelection_ApplyAirTransitToList(const uint16 *list, uint16 count, uint8 houseID, uint16 packed);
...
extern uint16 Unit_Autonomy_FindTargetWithin(struct Unit *unit, uint16 radius, bool wayOnly);
